...
<head>
  ...
  $favicon = 'public/uploads/apps/' . setting('app_favicon');
  $favicon_info = getimagesize($favicon);
  $image = 'public/uploads/apps/' . setting('app_image');
  ...
  <!-- <link rel="icon" type="image/x-icon" href="<?= base_url(); ?>public/assets/compiled/svg/favicon.svg">

  <link rel="shortcut icon" href="<?= base_url(); ?>public/assets/compiled/svg/favicon.svg" type="image/x-icon">
