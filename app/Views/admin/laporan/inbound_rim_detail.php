    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" method="get" id="form-export">
                        <div class="row mt-3">
                            <div class="col-md-2">
                                <div class="mb-2">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <?php if (hasPermissions('inbound_rim_detail_export')) : ?>
                    ...
                    <div class="row">
                        <div class="col table-responsive" id="area_lod">
                            <?= $this->include('admin/laporan/inbound_rim_detail_ajax'); ?>
                        </div>
                    </div>
                </div>
...
<script>
    $('#export').on('click', function() {
        // var bulan = $('#bulan').val();
        // var link = '<?= base_url(); ?>laporan/inbound_rim_detail_export?bulan=' + bulan;
        // // console.log(link);
        // window.open(link, '_blank');

        var str = $("form#form-export").serialize();
        window.open('<?= base_url(); ?>laporan/inbound_rim_detail_export?' + str);
    })
    ...
    $('#submit').on('click', function() {
        ...
        $.ajax({
            url: '<?= base_url(); ?>laporan/inbound_rim_detail_ajax',
            method: 'GET', // POST
            data: {
                bulan: bulan,
                tahun: tahun,
