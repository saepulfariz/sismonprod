        ...
        <form action="<?= base_url($_page->link . '/' . $data['id']); ?>" method="post">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control <?= ($error = validation_show_error('variable_name')) ? 'border-danger' : ''; ?>" id="variable_name" name="variable_name" placeholder="variable_Name" value="<?= $data['variable_name']; ?>">
