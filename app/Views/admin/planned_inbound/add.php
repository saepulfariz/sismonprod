            ...
            <div class="row">
              <div class="col-md-6 mb-2">
                <div class="form-group">
                  ...
                  <select name="ip_seven" id="ip_seven" class="form-control <?= ($error = validation_show_error('ip_seven')) ? 'border-danger' : ''; ?>">
                    ...
                    <?php foreach ($ip_seven as $d) : ?>
                      <?php if (@old('ip_seven') == $d['ip_seven']) : ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" readonly class="readonly form-control <?= ($error = validation_show_error('ip_code')) ? 'border-danger' : ''; ?>" id="ip_code" name="ip_code" placeholder="Ip Code" value="<?= old('ip_code'); ?>">
                  <?= ($error) ? '<span class="error text-danger mb-2">' . $error . '</span>' : ''; ?>
                </div>

                <div class="form-group">
                  <label for="cost_center">Cost Center</label>
                  <input type="text" readonly class="readonly form-control <?= ($error = validation_show_error('cost_center')) ? 'border-danger' : ''; ?>" id="cost_center" name="cost_center" placeholder="Cost Center" value="<?= old('cost_center'); ?>">
                  <?= ($error) ? '<span class="error text-danger mb-2">' . $error . '</span>' : ''; ?>
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control <?= ($error = validation_show_error('rim')) ? 'border-danger' : ''; ?>" id="rim" name="rim" placeholder="RIM" value="<?= old('rim'); ?>">
                  <?= ($error) ? '<span class="error text-danger mb-2">' . $error . '</span>' : ''; ?>
                </div>

                <div class="form-group">
                  <label for="p_date">DATE</label>
                  <input type="date" class="form-control <?= ($error = validation_show_error('p_date')) ? 'border-danger' : ''; ?>" id="p_date" name="p_date" placeholder="DATE" value="<?= old('p_date'); ?>">
                  <?= ($error) ? '<span class="error text-danger mb-2">' . $error . '</span>' : ''; ?>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control <?= ($error = validation_show_error('qty')) ? 'border-danger' : ''; ?>" id="qty" name="qty" placeholder="QTY" value="<?= ($old = old('qty')) ? $old : '0'; ?>">
                  <?= ($error) ? '<span class="error text-danger mb-2">' . $error . '</span>' : ''; ?>
                </div>
